				...
				<div class="col-md-4">
					<form action="TRAITEMENT/systeme.php" method="POST" enctype="multipart/form-data">
						<div class="profile-img">
							...
							<h6 class="text-muted"><?php if (isset($_SESSION['type'])) {
														echo $_SESSION['type'];
													} else {
														echo "...";
													} ?></h6>
						...
						<div class="col-md-12">
							<div class="profile-work">
								<ul class="list-group">
									...
									<li class="list-group-item text-right"><span class="pull-left"><strong>Partage</strong></span>
										<?php if (isset($_SESSION['partages'])) {
									...
									<li class="list-group-item text-right"><span class="pull-left"><strong>Nombre de Projet</strong></span>
									...
									<li class="list-group-item text-right"><span class="pull-left"><strong>Followers</strong></span>
										<?php if (isset($_SESSION['followers'])) {
