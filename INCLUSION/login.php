...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="#"><img class="card-img-top" src="IMAGES/mangaka.png" alt=""></a>
        <div class="card-body">
          <h4 class="card-title">
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="#"><img class="card-img-top" src="IMAGES/Bakuman.jpg" alt=""></a>
        <div class="card-body">
          <h4 class="card-title">
            <a href="#">Bakuman</a>
          </h4>
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="#"><img class="card-img-top" src="IMAGES/One-Piece.jpg" alt=""></a>
        <div class="card-body">
          <h4 class="card-title">
            <a href="#">One piece</a>
          </h4>
