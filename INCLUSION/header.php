		...
		<a class="navbar-brand" href="index.php">BLUE</a>
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small" placeholder="Rechercher un projet ou un auteur..." aria-label="Search" aria-describedby="basic-addon2">
		...
		echo "
            ...
            <li class=\"nav-item dropdown no-arrow\">
              ...
              <a class=\"nav-link dropdown-toggle\" href=\"#\" id=\"userDropdown\" role=\"button\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">
                <span class=\"mr-2 d-none d-lg-inline text-gray-600 small\">Bienvenue, <strong>".$_SESSION['pseudo']."</strong></span>
                <img class=\"img-profile rounded-circle\" src=\"IMAGES/PROFILS/".$_SESSION['image']."\">
              </a>
